...
func testMetricsData() pmetric.Metrics {
	...
	dp61.SetIntVal(200)
	m13 := ms.AppendEmpty()
	m13.SetName("system.network.packets.receive")
	m13.SetDescription("The number of packets received")
	m13.SetDataType(pmetric.MetricDataTypeGauge)
	dp62 := m13.Gauge().DataPoints().AppendEmpty()
