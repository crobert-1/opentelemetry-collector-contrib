...
func TestMetricsBuilder(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			allMetricsCount++
			mb.RecordSqlserverDatabaseIoReadBytesDataPoint(ts, "1", "physical_filename-val", "logical_filename-val", "file_type-val")

			allMetricsCount++
			mb.RecordSqlserverDatabaseIoReadLatencyDataPoint(ts, 1, "physical_filename-val", "logical_filename-val", "file_type-val")

			allMetricsCount++
			mb.RecordSqlserverDatabaseIoReadsDataPoint(ts, "1", "physical_filename-val", "logical_filename-val", "file_type-val")

			allMetricsCount++
			mb.RecordSqlserverDatabaseIoWriteBytesDataPoint(ts, "1", "physical_filename-val", "logical_filename-val", "file_type-val")

			allMetricsCount++
			mb.RecordSqlserverDatabaseIoWriteLatencyDataPoint(ts, 1, "physical_filename-val", "logical_filename-val", "file_type-val")

			allMetricsCount++
			mb.RecordSqlserverDatabaseIoWritesDataPoint(ts, "1", "physical_filename-val", "logical_filename-val", "file_type-val")
			...
			for i := 0; i < ms.Len(); i++ {
				...
				case "sqlserver.batch.sql_recompilation.rate":
					...
					assert.Equal(t, pmetric.NumberDataPointValueTypeDouble, dp.ValueType())
					assert.Equal(t, float64(1), dp.DoubleValue())
				case "sqlserver.database.io.read_bytes":
					assert.False(t, validatedMetrics["sqlserver.database.io.read_bytes"], "Found a duplicate in the metrics slice: sqlserver.database.io.read_bytes")
					validatedMetrics["sqlserver.database.io.read_bytes"] = true
					assert.Equal(t, pmetric.MetricTypeSum, ms.At(i).Type())
					assert.Equal(t, 1, ms.At(i).Sum().DataPoints().Len())
					assert.Equal(t, "Total number of bytes read on this file.", ms.At(i).Description())
				...
				case "sqlserver.database.io.read_latency":
					...
					assert.True(t, ok)
					assert.EqualValues(t, "file_type-val", attrVal.Str())
				case "sqlserver.database.io.reads":
					assert.False(t, validatedMetrics["sqlserver.database.io.reads"], "Found a duplicate in the metrics slice: sqlserver.database.io.reads")
					validatedMetrics["sqlserver.database.io.reads"] = true
					assert.Equal(t, pmetric.MetricTypeSum, ms.At(i).Type())
					assert.Equal(t, 1, ms.At(i).Sum().DataPoints().Len())
					assert.Equal(t, "Number of reads issued on the file.", ms.At(i).Description())
					...
					assert.True(t, ok)
					assert.EqualValues(t, "file_type-val", attrVal.Str())
				case "sqlserver.database.io.write_bytes":
					assert.False(t, validatedMetrics["sqlserver.database.io.write_bytes"], "Found a duplicate in the metrics slice: sqlserver.database.io.write_bytes")
					validatedMetrics["sqlserver.database.io.write_bytes"] = true
					assert.Equal(t, pmetric.MetricTypeSum, ms.At(i).Type())
					assert.Equal(t, 1, ms.At(i).Sum().DataPoints().Len())
					assert.Equal(t, "Total number of bytes written to the file.", ms.At(i).Description())
					assert.Equal(t, "{By}", ms.At(i).Unit())
					assert.Equal(t, true, ms.At(i).Sum().IsMonotonic())
					assert.Equal(t, pmetric.AggregationTemporalityCumulative, ms.At(i).Sum().AggregationTemporality())
					dp := ms.At(i).Sum().DataPoints().At(0)
				...
				case "sqlserver.database.io.write_latency":
					...
					assert.True(t, ok)
					assert.EqualValues(t, "file_type-val", attrVal.Str())
				case "sqlserver.database.io.writes":
					assert.False(t, validatedMetrics["sqlserver.database.io.writes"], "Found a duplicate in the metrics slice: sqlserver.database.io.writes")
					validatedMetrics["sqlserver.database.io.writes"] = true
					assert.Equal(t, pmetric.MetricTypeSum, ms.At(i).Type())
					assert.Equal(t, 1, ms.At(i).Sum().DataPoints().Len())
					assert.Equal(t, "Number of writes made on this file.", ms.At(i).Description())
