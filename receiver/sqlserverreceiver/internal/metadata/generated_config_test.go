		...
		},
		{
			...
			want: MetricsBuilderConfig{
				Metrics: MetricsConfig{
					...
					SqlserverDatabaseIoReadBytes:         MetricConfig{Enabled: true},
					SqlserverDatabaseIoReadLatency:       MetricConfig{Enabled: true},
					SqlserverDatabaseIoReads:             MetricConfig{Enabled: true},
					SqlserverDatabaseIoWriteBytes:        MetricConfig{Enabled: true},
					SqlserverDatabaseIoWriteLatency:      MetricConfig{Enabled: true},
					SqlserverDatabaseIoWrites:            MetricConfig{Enabled: true},
		...
		},
		{
			...
			want: MetricsBuilderConfig{
				Metrics: MetricsConfig{
					...
					SqlserverDatabaseIoReadBytes:         MetricConfig{Enabled: false},
					SqlserverDatabaseIoReadLatency:       MetricConfig{Enabled: false},
					SqlserverDatabaseIoReads:             MetricConfig{Enabled: false},
					SqlserverDatabaseIoWriteBytes:        MetricConfig{Enabled: false},
					SqlserverDatabaseIoWriteLatency:      MetricConfig{Enabled: false},
					SqlserverDatabaseIoWrites:            MetricConfig{Enabled: false},
