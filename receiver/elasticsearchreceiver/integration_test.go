...
func TestIntegration(t *testing.T) {
	t.Skip("TODO: Skipping due to intermittent failures. See https://github.com/open-telemetry/opentelemetry-collector-contrib/issues/32656 for more information.")
